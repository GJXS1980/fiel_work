...
from GJXS.utils.common import path, make_dir, remove_file
...
BLOCK_TYPES = {"Function_C15": COILS,
               "Function_C02": DISCRETE_INPUTS,
               "Function_C03": HOLDING_REGISTERS,
               "Function_C16": ANALOG_INPUTS}
