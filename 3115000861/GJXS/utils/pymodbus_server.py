...
if __name__ == "__main__":
    ...
    s.start()
    s.add_slave(1)
    s.add_block(1, "Function C03", "Function_C03", 0, 100)
    s.add_block(1, "Function C15", "Function_C03", 0, 100)
    s.set_values(1, "Function C03", 0, [34] * 55)
    log.info(s.get_values(1, "Function C03", 0, 100))
    s.stop()
