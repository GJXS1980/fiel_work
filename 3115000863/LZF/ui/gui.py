...
from LZF.utils.modbus import BLOCK_TYPES, configure_modbus_logger
from LZF.ui.settings import SettingIntegerWithRange
from LZF.utils.backgroundJob import BackgroundJob
import re
import os
import platform
...
if USE_PYMODBUS:
    from LZF.utils.pymodbus_server import ModbusSimu
else:
    from LZF.utils.modbus import ModbusSimu


MAP = {
    "function code15": "function_code15",
    'function code02': 'function_code02',
    'function code16': 'function_code16',
    'function code03': 'function_code03'
}
PARENT = __name__.split(".")[0]
settings_icon = resource_filename(PARENT, "assets/control.png")
app_icon = resource_filename(PARENT, "assets/logo.jpg")
...
class Gui(BoxLayout):
    ...
    data_model_function_code15 = ObjectProperty()
    data_model_function_code02 = ObjectProperty()
    data_model_function_code16 = ObjectProperty()
    data_model_function_code03 = ObjectProperty()
    ...
    def _init_coils(self):
        ...
        self.data_model_function_code15.init(
            blockname="function_code15",
        ...
        self.data_model_function_code02.init(
            blockname="function_code02",
            simulate=self.simulating,
            time_interval=time_interval,
            minval=minval,
            maxval=maxval,
    ...
    def _init_registers(self):
        ...
        self.block_size = int(eval(self.config.get("Modbus Protocol",
                                                   "block size")))
        self.data_model_function_code16.init(
            blockname="function_code16",
            simulate=self.simulating,
            time_interval=time_interval,
            minval=minval,
            maxval=maxval,
        ...
        self.data_model_function_code03.init(
            blockname="function_code03",
            simulate=self.simulating,
            time_interval=time_interval,
            minval=minval,
            maxval=maxval,
        ...
        for slave_to_add in xrange(start_slave_add,
            ...
            self.data_map[str(slave_to_add)] = {
                "function_code15": {
                    'data': {},
                    'item_strings': [],
                    "instance": self.data_model_function_code15,
                    "dirty": False
                },
                "function_code02": {
                    'data': {},
                    'item_strings': [],
                    "instance": self.data_model_function_code02,
                    "dirty": False
                },
                "function_code16": {
                    'data': {},
                    'item_strings': [],
                    "instance": self.data_model_function_code16,
                    "dirty": False
                },
                "function_code03": {
                    'data': {},
                    'item_strings': [],
                    "instance": self.data_model_function_code03,
                    "dirty": False
                }
            }
    ...
    def change_simulation_settings(self, **kwargs):
        self.data_model_function_code15.reinit(**kwargs)
        self.data_model_function_code02.reinit(**kwargs)
        self.data_model_function_code16.reinit(**kwargs)
        self.data_model_function_code03.reinit(**kwargs)
    ...
    def change_datamodel_settings(self, key, value):
        ...
        if "bin" in key:
            self.data_model_function_code15.reinit(**data)
            self.data_model_function_code02.reinit(**data)
        else:
            self.data_model_function_code16.reinit(**data)
            self.data_model_function_code03.reinit(**data)
    ...
    def _simulate(self):
        self.data_model_function_code15.start_stop_simulation(self.simulating)
        self.data_model_function_code02.start_stop_simulation(self.simulating)
        self.data_model_function_code16.start_stop_simulation(self.simulating)
        self.data_model_function_code03.start_stop_simulation(
            self.simulating)

    def reset_simulation(self, *args):
        if not self.simulating:
            self.data_model_function_code15.reset_block_values()
            self.data_model_function_code02.reset_block_values()
            self.data_model_function_code16.reset_block_values()
            self.data_model_function_code03.reset_block_values()
    ...
    def load_state(self):
        ...
        with open(SLAVES_FILE, 'r') as f:
            ...
            memory_map = {
                'function_code15': self.data_models.tab_list[3],
                'function_code02': self.data_models.tab_list[2],
                'function_code16': self.data_models.tab_list[1],
                'function_code03': self.data_models.tab_list[0]
            }
