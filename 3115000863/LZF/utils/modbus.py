...
from LZF.utils.common import path, make_dir, remove_file
...
BLOCK_TYPES = {"function_code15": COILS,
               "function_code02": DISCRETE_INPUTS,
               "function_code03": HOLDING_REGISTERS,
               "function_code16": ANALOG_INPUTS}
