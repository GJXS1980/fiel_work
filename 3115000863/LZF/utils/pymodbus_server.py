...
if __name__ == "__main__":
    ...
    s.start()
    s.add_slave(1)
    s.add_block(1, "function code03", "function_code03", 0, 100)
    s.add_block(1, "function code15", "function code03", 0, 100)
    s.set_values(1, "function code03", 0, [34] * 55)
    log.info(s.get_values(1, "function code03", 0, 100))
    s.stop()
