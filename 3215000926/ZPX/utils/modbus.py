...
from ZPX.utils.common import path, make_dir, remove_file
...
BLOCK_TYPES = {"Fun_Code15": COILS,
               "Fun_Code02": DISCRETE_INPUTS,
               "Fun_Code03": HOLDING_REGISTERS,
               "Fun_Code16": ANALOG_INPUTS}
